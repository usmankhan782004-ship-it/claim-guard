...
const TIERS: PricingTier[] = [
    {
        ...
        price: 0,
        period: "forever",
        tagline: "Try your first bill — no credit card needed",
        icon: <Shield className="w-6 h-6" />,
        features: [
            "1 free bill analysis",
            "AI-generated dispute letter preview",
            "All 4 bill categories",
            "Basic savings estimate",
            "Pay 20% success fee only if you save",
        ],
        ctaLabel: "Start Free",
    ...
    },
    {
        ...
        price: 29,
        period: "/month",
        tagline: "For individuals serious about saving money",
        ...
        features: [
            ...
            "Urgency countdown + filing windows",
            "AI legal reasoning sidebar",
            "Email support",
        ],
        ctaLabel: "Get Defender",
    ...
    },
    {
        ...
        features: [
            ...
            "Convenience fee & deposit detection",
            "Good Driver + Loyalty statute analysis",
            "Estimated vs actual meter checks",
            "Service connection junk fee flagging",
            "Lifetime wealth growth projections",
            "Wise / Bank Transfer payment support",
        ],
        highlight: true,
        badge: "✦ Most Popular",
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    {/* Invite Members button for Family Vault */}
                                    {tier.id === "family_vault" && (
                                        <button
                                            onClick={() => setInviteOpen(true)}
                                            className="w-full mt-3 py-2.5 rounded-xl text-xs font-medium flex items-center justify-center gap-2 bg-white/[0.03] border border-emerald-500/15 text-emerald-400/80 hover:bg-emerald-500/10 hover:text-emerald-300 transition-all"
